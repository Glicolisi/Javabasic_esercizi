package javabasics.Javabasic_esercizi._5;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        myVariable--;
        System.out.println(myVariable);// Write your code here
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        double myVariable=10;
        myVariable*=2;
        System.out.println(myVariable);
        double newVariable=5;
        newVariable/=2;
    ...
    private static void exercise3() {
        ...
        System.out.println(fahrenheit);// Write your code here
    }
    ...
    private static void exercise4Bonus() {
        ...
        age++;
        age++;
        System.out.println(age);// Write your code here
    }
